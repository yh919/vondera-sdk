...
var VonderaSDK = (() => {
  ...
  // src/endpoints/wishlist.ts
  var WishlistEndpoint = class {
    constructor(http) {
      this.http = http;
    }
    /**
  ...
  var ProductsEndpoint = class {
    ...
    async reviews(productId, page = 1, limit = 5) {
